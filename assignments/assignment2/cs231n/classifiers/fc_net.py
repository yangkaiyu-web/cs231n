...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for i in range(self.num_layers):
          self.params['W' + str(i + 1)] = np.random.normal(0, weight_scale, (hidden_dims[i], hidden_dims[i + 1]))
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers - 1):
          ...
          if self.normalization == None:
            ...
            out, cache = affine_layernorm_relu_forward(out, W, b, gamma, beta, ln_param)
          if self.use_dropout:
        ...
        affine_cache = caches[self.num_layers - 1]
        dout, dout_w, dout_b = affine_backward(dout, affine_cache)
        dout_w += self.reg * self.params['W' + str(self.num_layers)]

        grads['W' + str(self.num_layers)] = dout_w
        grads['b' + str(self.num_layers)] = dout_b
